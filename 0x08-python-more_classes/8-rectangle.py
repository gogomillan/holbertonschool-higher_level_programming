...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        """Class static method to return the biggest of two rectangles

        Args:
            rect_1 (Rectangle object): The first to compate
            rect_2 (Rectangle object): The second to compate

        Returns:
            The biggest object (according to the area)
        """
        if type(rect_1) is not Rectangle:
            raise TypeError("rect_1 must be an instance of Rectangle")
        if type(rect_2) is not Rectangle:
            raise TypeError("rect_2 must be an instance of Rectangle")
        a = rect_1.__width * rect_1.__height
        b = rect_2.__width * rect_2.__height
        if a >= b:
            return rect_1
        return rect_2
